import { HDropdownModel, HDropdownProps } from '../../manage/types/components/dropdown';
import { nextTick } from 'vue';
import { IconName } from '../../manage/types/icon-names';
type __VLS_Props = HDropdownProps;
declare function getUpdatedValidState(): import('../..').HFieldValidationState | undefined;
type __VLS_PublicProps = {
    'dropdownModel'?: HDropdownModel;
} & __VLS_Props;
...
declare const __VLS_component: import('vue').DefineComponent<__VLS_PublicProps, {
    ...
    "update:dropdownModel": (value: HDropdownModel) => any;
}, string, import('vue').PublicProps, Readonly<__VLS_PublicProps> & Readonly<{
    "onUpdate:dropdownModel"?: ((value: HDropdownModel) => any) | undefined;
}>, {
    isDisabled: boolean;
    labelPosition: Extract<import('../../manage/types/global').Position, "top" | "left">;
    hasMessage: boolean;
