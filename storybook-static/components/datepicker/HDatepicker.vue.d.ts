...
type __VLS_Props = HDatepickerProps;
...
declare const __VLS_component: import('vue').DefineComponent<__VLS_PublicProps, {
    ...
    "update:dateModel": (value: HDatepickerModel) => any;
    ...
    placeholder: string;
    readonly: boolean;
    postIconName: import('../../manage').IconName;
    containerZIndex: number;
    contentPosition: import('../../manage').PositionY;
    datepickerWidthClass: string;
    datepickerPosition: import('../../manage').PositionX;
    showEmpty: boolean;
